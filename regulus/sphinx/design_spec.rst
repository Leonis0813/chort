...
4. 取得したレートをグラフ化して表示する
5. 以降は10秒ごとにRates_Controller#updateを実行してグラフを更新する
...
| スクリプト名        | 処理内容                                           |
+=====================+====================================================+
| rates.import.rb     | YQLを利用してレート情報を取得&DBに登録する         |
+---------------------+----------------------------------------------------+
| rates.copy.rb       | 開発環境のテーブルを本番環境にコピーする           |
+---------------------+----------------------------------------------------+
...
+---------------------+---------------------------------------------------------------+
| tweets.copy.rb      | 登録したツイート情報を開発環境と本番環境にコピーする          |
+---------------------+---------------------------------------------------------------+
...
+------------------------+-----------------------------------------------------------+
| articless.copy.rb      | 登録した記事情報を開発環境と本番環境にコピーする          |
+------------------------+-----------------------------------------------------------+
