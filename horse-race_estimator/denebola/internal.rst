...
レースのエントリー数分7〜21を繰り返す

8. エントリー情報を抽出する
9. 10を実行する
10. 抽出したエントリー情報を登録/更新する

11. 12を実行する
12. 抽出した騎手情報を登録/更新する

エントリー情報と騎手情報の登録/更新に成功した場合は13, 14を実行する

13. 騎手情報から戦績を取得する
14. 戦績にエントリーを追加する

15. 16〜19を実行する
16. 競走馬情報が書かれたHTMLファイルを読み込む
17. HTMLファイルをパースする
18. 競走馬情報を抽出する
19. 抽出した競走馬情報を登録/更新する

エントリー情報と競走馬情報の登録/更新に成功した場合は20, 21を実行する

20. 競走馬情報から戦績を取得する
21. 戦績にエントリーを追加する

22. 払い戻し情報を抽出する
23. レース情報に払い戻し情報を追加する
