...
11. 予測ジョブと分析ジョブを紐付ける
12. 予測パラメーターをファイルに出力する
13. ペアを予測ジョブ情報に登録する

最新データを使って自動予測を行う場合は14〜16を行う

14. 最新のデータをポーリングするために15〜16を行う
15. 最新のローソク足情報が登録されたか確認する
16. 最新の移動平均線情報が登録されたか確認する

17. 予測スクリプトを実行する
18. 予測結果をファイルから読み込む
19. 予測結果をDBに登録してジョブの状態を更新する
20. 予測ジョブを完了状態にする
21. 予測ジョブが完了状態になったことをブロードキャストする
